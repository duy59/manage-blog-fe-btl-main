...
<div className="mb-5">
    ...
    <div className="flex items-center justify-center gap-2">
        ...
        <button type="button" className="btn btn-secondary" onClick={showMessage6}>
            ...
            <div className="mb-5">
                <h6
                    className="mb-3 text-center text-base font-semibold dark:text-white-light">Top Position</h6>
                ...
                <h6
                    className="mb-3 text-center text-base font-semibold dark:text-white-light">Bottom Position</h6>
                <div className="flex items-center justify-center gap-2">
                    <button type="button" className="btn btn-dark" onClick={showMessage4}>
                        Bottom Left
                    </button>
