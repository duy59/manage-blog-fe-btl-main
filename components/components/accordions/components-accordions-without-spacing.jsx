...
<div className="mb-5">
    <div className="border border-[#d3d3d3] dark:border-[#3b3f5c] rounded font-semibold">
        ...
        <div>
            ...
            <div className="mb-5">
                <div
                    className="rounded border border-[#d3d3d3] font-semibold dark:border-[#3b3f5c]">
                    <div className="border-b border-[#d3d3d3] dark:border-[#3b3f5c]">
                        <button
                            type="button"
                            ...
                            Collapsible Group Item #1
                            <div
                                className={`${active1 === '1' ? 'rotate-180' : ''} ltr:ml-auto rtl:mr-auto`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                    ...
                    <div className="border-b border-[#d3d3d3] dark:border-[#3b3f5c]">
                        <button
                            ...
                            Collapsible Group Item #2
                            <div
                                className={`${active1 === '2' ? 'rotate-180' : ''} ltr:ml-auto rtl:mr-auto`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                    ...
                    <div>
                        <button
                            ...
                            Collapsible Group Item #3
                            <div
                                className={`${active1 === '3' ? 'rotate-180' : ''} ltr:ml-auto rtl:mr-auto`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
