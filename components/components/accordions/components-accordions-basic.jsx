                ...
                <div className="space-y-2 font-semibold">
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #1
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active === '1' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                    ...
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #2
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active === '2' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                    ...
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #3
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active === '3' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
