                ...
                <div className="space-y-2 font-semibold">
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #1
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active2 === '1' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                            <AnimateHeight duration={300} height={active2 === '1' ? 'auto' : 0}>
                                <div
                                    className="space-y-2 border-t border-[#d3d3d3] p-4 text-[13px] text-white-dark dark:border-[#1b2e4b]">
                                    <p>
                    ...
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #2
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active2 === '2' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
                            <AnimateHeight duration={300} height={active2 === '2' ? 'auto' : 0}>
                                <div
                                    className="border-t border-[#d3d3d3] p-4 text-[13px] dark:border-[#1b2e4b]">
                                    <ul className="space-y-1">
                                        <li>
                                            <button type="button">Apple</button>
                                        </li>
                    ...
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]">
                        <button
                            ...
                            Collapsible Group Item #3
                            <div
                                className={`ltr:ml-auto rtl:mr-auto ${active2 === '3' ? 'rotate-180' : ''}`}>
                                <IconCaretDown />
                            </div>
                        </button>
                        <div>
