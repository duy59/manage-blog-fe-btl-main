        ...
        <div className="md:flex space-y-4 md:space-y-0 mt-5 md:mt-16 text-white-dark">
            ...
            <div className="mb-5">
                <div className="mx-auto max-w-[320px] dark:text-white-dark md:max-w-[1140px]">
                    <div
                        className="mt-5 flex justify-center space-x-4 text-center text-base font-semibold rtl:space-x-reverse md:mt-10">
                        <span className={`${!yearlyPrice ? 'text-primary' : 'text-white-dark'}`}>Monthly</span>
                    ...
                    <div className="mt-5 space-y-4 text-white-dark md:mt-16 md:flex md:space-y-0">
                        <div
                            ...
                            <div className="mb-6">
                                <strong
                                    className="mb-3 inline-block text-[15px] text-black dark:text-white-light">Cloud Hosting Features</strong>
                                <ul className="space-y-3">
                                    <li>Single Domain</li>
                                    <li>50 GB SSD</li>
                                    <li>1 TB Premium Bandwidth</li>
                        ...
                        <div
                            className="relative rounded-t-md border border-white-light p-4 pt-14 transition-all duration-300 dark:border-[#1b2e4b] lg:p-9">
                            <div
                                className="absolute inset-x-0 top-0 flex h-10 items-center justify-center rounded-t-md bg-primary text-base text-white md:-top-[30px]">Most Popular</div>
                            ...
                            <div className="mb-6">
                                <strong
                                    className="mb-3 inline-block text-[15px]  text-black dark:text-white-light">VPS Hosting Features</strong>
                                <ul className="space-y-3">
                                    <li>5 Domains</li>
                                    <li>100 GB SSD</li>
                                    <li>2 TB Premium Bandwidth</li>
                        ...
                        <div
                            className="rounded-md border border-white-light p-4 transition-all duration-300 hover:shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] dark:border-[#1b2e4b] ltr:md:rounded-l-none ltr:md:border-l-0 rtl:md:rounded-r-none rtl:md:border-r-0 lg:p-9">
                            ...
                            <div className="mb-6">
                                <strong
                                    className="mb-3 inline-block text-[15px]  text-black dark:text-white-light">Business Hosting Features</strong>
                                <ul className="space-y-3">
                                    <li>Unlimited Domains</li>
                                    <li>1 TB SSD</li>
                                    <li>5 TB Premium Bandwidth</li>
