                    ...
                    <div className="relative z-[1]">
                        ...
                        <ul className="mb-5 grid grid-cols-3">
                            <li className="mx-auto">
                                ...
                                <span
                                    className={`${activeTab6 === 1 ? 'text-primary ' : ''}text-center mt-2 block`}>Home</span>
                            </li>
                            <li className="mx-auto">
                                <button
                                    type="button"
                                ...
                                <span
                                    className={`${activeTab6 === 2 ? 'text-primary ' : ''}text-center mt-2 block`}>About</span>
                            </li>
                            <li className="mx-auto">
                                <button
                                    type="button"
                                ...
                                <span
                                    className={`${activeTab6 === 3 ? 'text-primary ' : ''}text-center mt-2 block`}>Success</span>
                            </li>
                        </ul>
                    </div>
                    <div>
