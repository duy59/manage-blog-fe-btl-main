        ...
        <div>
            ...
            <div className="relative mt-5 flex flex-col gap-5 xl:flex-row">
                            ...
                            <div key={item.id}>
                                <button
                                    ...
                                    <div className="ltr:pr-4 rtl:pl-4">
                                        ...
                                        <div
                                            className={`mt-2 flex items-center ${item.isUp ? 'text-success' : 'text-danger'}`}>
                ...
                <div className="panel flex-1 p-0">
                    <div
                        className="flex-wrap items-center border-b border-[#ebedf2] p-4 dark:border-[#191e3a] md:flex">
                        <div className="flex flex-1 items-start ltr:pr-4 rtl:pl-4">
                            ...
                            <div>
                                ...
                                <div
                                    className={`mt-2 flex items-center ${currentCoin.isUp ? 'text-success' : 'text-danger'}`}>
                        ...
                        <ul
                            className="mt-5 grid grid-cols-2 divide-[#ebedf2] font-semibold text-white-dark rtl:divide-x-reverse dark:divide-[#253b5c] sm:mt-0 sm:grid-cols-4 sm:divide-x ltr:md:ml-auto rtl:md:mr-auto">
                    ...
                    <div
                        className="mb-5 grid grid-rows-1 gap-4 border-b border-[#ebedf2] p-4 dark:border-[#253b5c] sm:grid-cols-4">
                        <div>
                    ...
                    {/*  selected chart  */}
                    <div className="flex-1 px-4">{isMounted && <ReactApexChart
