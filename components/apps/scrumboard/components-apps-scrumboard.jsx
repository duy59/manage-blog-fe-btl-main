                                        ...
                                        {project.tasks.map((task) => {
                                            return (
                                                <div className="sortable-list " key={project.id + '' + task.id}>
                                                    <div
                                                        className="mb-5 cursor-move space-y-3 rounded-md bg-[#f4f4f4] p-3 pb-5 shadow dark:bg-white-dark/20">
                                                        {task.image ? <img
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-2">
                                                            {task.tags?.length ? (
                                                                ...
                                                                <div
                                                                    className="btn flex px-2 py-1 text-white-dark shadow-none dark:border-white-dark/50">
                                                                    <IconTag className="shrink-0" />
                    ...
                    <div className="fixed inset-0 z-[999] overflow-y-auto">
                        <div className="flex min-h-screen items-center justify-center px-4">
                            <Dialog.Panel
                                ...
                                <div
                                    className="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5 dark:bg-[#121c2c]">{paramsTask.id ? 'Edit Task' : 'Add Task'}</div>
                                <div className="p-5">
                        ...
                        <div className="flex min-h-screen items-center justify-center px-4 ">
                            <Transition.Child
                                ...
                                <Dialog.Panel
                                    ...
                                    <div
                                        className="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5 dark:bg-[#121c2c]">Delete Task</div>
