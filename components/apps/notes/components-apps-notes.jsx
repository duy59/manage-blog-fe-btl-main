            ...
            <div className="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
                ...
                <div
                    ...
                    <div className="flex h-full flex-col pb-16">
                        ...
                        <div
                            className="my-4 h-px w-full border-b border-white-light dark:border-[#1b2e4b]"></div>
                        <PerfectScrollbar
                                                    ...
                                                    <div className="flex w-max items-center">
                                                        <div className="flex-none">
                                                            ...
                                                            {!note.thumb && note.user && (
                                                                <div
                                                                    className="grid h-8 w-8 place-content-center rounded-full bg-gray-300 text-sm font-semibold dark:bg-gray-700">
                                ...
                                <div className="flex min-h-full items-center justify-center px-4 py-8">
                                    <Transition.Child
                                        ...
                                        <Dialog.Panel
                                            ...
                                            <div
                                                className="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5 dark:bg-[#121c2c]">Delete Notes</div>
                                            <div className="p-5 text-center">
                                                <div
                                                    className="mx-auto w-fit rounded-full bg-danger p-4 text-white ring-4 ring-danger/30">
