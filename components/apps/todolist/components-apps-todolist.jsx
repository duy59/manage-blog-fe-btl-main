            ...
            <div className="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
                <div
                    ...
                    <div className="flex h-full flex-col pb-16">
                        ...
                        <div
                            className="mb-5 h-px w-full border-b border-white-light dark:border-[#1b2e4b]"></div>
                        <PerfectScrollbar
                            className="relative h-full grow ltr:-mr-3.5 ltr:pr-3.5 rtl:-ml-3.5 rtl:pl-3.5">
                            <div className="space-y-1">
                                <button
                                    ...
                                    <div
                                        className="whitespace-nowrap rounded-md bg-primary-light px-2 py-0.5 font-semibold dark:bg-[#060818]">
                ...
                <div className="panel h-full flex-1 overflow-auto p-0">
                    <div className="flex h-full flex-col">
                        <div className="flex w-full flex-col gap-4 p-4 sm:flex-row sm:items-center">
                            ...
                            <div
                                className="flex flex-1 items-center justify-center sm:flex-auto sm:justify-end">
                        ...
                        {pagedTasks.length ? (
                            <div
                                className="table-responsive min-h-[400px] grow overflow-y-auto sm:min-h-[300px]">
                                <table className="table-hover">
                                    <tbody>
                                        {pagedTasks.map((task) => {
                                            return (
                                                <tr
                                                    className={`group cursor-pointer ${task.status === 'complete' ? 'bg-white-light/30 dark:bg-[#1a2941] ' : ''}`}
                                                    key={task.id}>
                                                    <td className="w-1">
                                                        <input
                                                            type="checkbox"
                                                    ...
                                                    <td>
                                                        <div onClick={() => viewTask(task)}>
                                                            <div
                                                                className={`whitespace-nowrap text-base font-semibold group-hover:text-primary ${task.status === 'complete' ? 'line-through' : ''}`}>
                                                                {task.title}
                                                            </div>
                                                            <div
                                                                className={`line-clamp-1 min-w-[300px] overflow-hidden text-white-dark ${task.status === 'complete' ? 'line-through' : ''}`}>
                                                    ...
                                                    <td className="w-1">
                                                        <div
                                                            className="flex items-center space-x-2 ltr:justify-end rtl:justify-start rtl:space-x-reverse">
                                                            {task.priority && (
                                                    ...
                                                    <td className="w-1">
                                                        <p
                                                            className={`whitespace-nowrap font-medium text-white-dark ${task.status === 'complete' ? 'line-through' : ''}`}>{task.date}</p>
                                                    </td>
                                                    <td className="w-1">
                                                        <div className="flex w-max items-center justify-between">
                                                            <div className="flex-shrink-0 ltr:mr-2.5 rtl:ml-2.5">
                                                                ...
                                                                {!task.path && task.assignee ? (
                                                                    <div
                                                                        className="grid h-8 w-8 place-content-center rounded-full bg-primary text-sm font-semibold text-white">
                                                                ...
                                                                {!task.path && !task.assignee ? (
                                                                    <div
                                                                        className="grid h-8 w-8 place-content-center rounded-full border border-gray-300 dark:border-gray-800">
                            ...
                            <div
                                className="flex h-full min-h-[400px] items-center justify-center text-lg font-semibold sm:min-h-[300px]">No data available</div>
                        )}
                    </div>
                </div>
                                    ...
                                    <Dialog.Panel
                                        ...
                                        <div className="p-5">
                                            <form>
                                                ...
                                                <div
                                                    className="mt-8 flex items-center justify-end ltr:text-right rtl:text-left">
                                                    <button
                                                        type="button"
                            ...
                            <div className="flex min-h-full items-center justify-center px-4 py-8">
                                <Transition.Child
                                    ...
                                    <Dialog.Panel
                                        ...
                                        <div
                                            className="flex flex-wrap items-center gap-2 bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5 dark:bg-[#121c2c]">
