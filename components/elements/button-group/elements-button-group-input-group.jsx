...
`}>
            <div className="mb-5">
                <div
                    className="flex w-full flex-wrap items-center justify-center gap-2 sm:justify-between">
                    <div>
                        <div className="relative inline-flex align-middle">
                            <button
                                type="button"
                    ...
                    <div className="relative flex flex-wrap items-stretch">
                        <div className="flex ltr:-mr-px rtl:-ml-px">
                            <span
                                className="flex items-center justify-center border border-white-light bg-[#f1f2f3] px-4 py-1.5 text-black ltr:rounded-l rtl:rounded-r dark:border-[#17263c] dark:bg-[#1a1c2d] dark:text-white-dark">
                                @
                            </span>
                        </div>
                        <input
