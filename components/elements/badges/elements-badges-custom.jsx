            ...
            <div className="mb-5">
                <div className="flex flex-wrap items-center justify-center gap-3">
                    <button type="button" className="btn btn-primary my-4">
                        ...
                        <span
                            className="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">9</span>
                    </button>
                    <button type="button" className="btn btn-info my-4">
                        <span>Twitter</span>
                        <span
                            className="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">4</span>
                    </button>
                    <button type="button" className="btn btn-secondary my-4 px-5">
                        ...
                        <span
                            className="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">8</span>
                    </button>
                    <button type="button" className="btn btn-dark my-4">
                        Notifications
                        <span className="badge my-0 bg-white-light text-black ltr:ml-4 rtl:mr-4">4</span>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        <span
                            className="badge my-4 flex items-center rounded-full bg-warning p-0 text-base ltr:pr-4 rtl:pl-4">
                            <img
                        ...
                        <span
                            className="badge my-4 flex items-center rounded-full bg-danger p-0 text-base ltr:pr-4 rtl:pl-4">
                            <img
                                src="/assets/images/profile-34.jpeg"
                                className="h-10 w-10 rounded-full object-cover"
                                alt="img" />
