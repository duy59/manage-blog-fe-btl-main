                ...
                <ul className="font-semibold">
                    <li className="py-[5px]">
                        <button
                            ...
                            <IconCaretDown
                                className={`relative -top-1 inline h-5 w-5 text-primary ltr:mr-2 rtl:ml-2 ${treeview1.includes('css') && 'rotate-180'}`} />
                    ...
                    <li className="py-[5px]">
                        <button
                            ...
                            <IconCaretDown
                                className={`relative -top-1 inline h-5 w-5 text-primary ltr:mr-2 rtl:ml-2 ${treeview1.includes('images') && 'rotate-180'}`} />
                            <IconFolder className="relative -top-1 inline text-primary ltr:mr-2 rtl:ml-2" />
                            Images
                        </button>
                        <AnimateHeight duration={300} height={treeview1.includes('images') ? 'auto' : 0}>
                    ...
                    <li className="py-[5px]">
                        <button
                            ...
                            <IconCaretDown
                                className={`relative -top-1 inline h-5 w-5 text-primary ltr:mr-2 rtl:ml-2 ${treeview1.includes('html') && 'rotate-180'}`} />
                            <IconFolder className="relative -top-1 inline text-primary ltr:mr-2 rtl:ml-2" />
                            HTML
                        </button>
                        <AnimateHeight duration={300} height={treeview1.includes('html') ? 'auto' : 0}>
                            <ul className="ltr:pl-14 rtl:pr-14">
                                <li className="py-[5px]">
                                    <button
                                        ...
                                        <IconCaretDown
                                            className={`relative -top-1 inline h-5 w-5 text-primary ltr:mr-2 rtl:ml-2 ${treeview1.includes('pages') && 'rotate-180'}`} />
                                        <IconFolder className="relative -top-1 inline text-primary ltr:mr-2 rtl:ml-2" />
                                        PAGES
                                    </button>
                                    <AnimateHeight duration={300} height={pagesSubMenu ? 'auto' : 0}>
