...
const Header = () => {
    ...
    const handleSignOut = async () => {
        const response = await fetch(`${process.env.domainApi}/api/logout`, {
            method: 'POST',
            headers: {
        ...
        if (data.code == 200) {
            sessionStorage.removeItem('emailLockScreen');
                ...
                <div
                    ...
                    <div
                        ...
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <span
                                className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">CMS XEMNHA</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="hidden ltr:mr-2 rtl:ml-2 sm:block">
                        <ul
                            className="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                            <li>
                                <Link
                                    href="/apps/calendar"
