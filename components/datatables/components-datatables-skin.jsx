...
const ComponentsDatatablesSkin = () => {
    ...
    useEffect(() => {
        setInitialRecords1(() => {
            return rowData.filter((item) => {
                return item.id.toString().includes(search1.toLowerCase()) ||
    ...
    useEffect(() => {
        setInitialRecords2(() => {
            return rowData.filter((item) => {
                return item.id.toString().includes(search2.toLowerCase()) ||
    ...
    useEffect(() => {
        setInitialRecords3(() => {
            return rowData.filter((item) => {
                return item.id.toString().includes(search3.toLowerCase()) ||
    ...
    useEffect(() => {
        setInitialRecords4(() => {
            return rowData.filter((item) => {
                return item.id.toString().includes(search4.toLowerCase()) ||
